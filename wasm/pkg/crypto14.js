...
* @param {string} plain_text_str
* @returns {any}
*/
module.exports.encrypt = function(key_str, plain_text_str) {
    const ptr0 = passStringToWasm0(key_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(plain_text_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
const path = require('path').join(__dirname, 'crypto14_bg.wasm');
